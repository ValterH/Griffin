...
from .base_gml_solution import BaseGNNSolutionConfig, BaseMultiTaskGMLSolution, BaseMultiTaskGNN
from .graph_dataset_config import GraphConfig
from .gnn import EdgeSAGEOFABaseConv, EdgeSAGEOFARelationConv, EdgeSAGEOFAConvConfig, HeteroGNNOFALayer


class SAGEOFASolutionConfig(BaseGNNSolutionConfig):
    hid_size : int
    dropout : float
    conv : EdgeSAGEOFAConvConfig = EdgeSAGEOFAConvConfig()


class HeteroSAGEOFA(nn.Module):
    def __init__(
        self,
        graph_config : GraphConfig,
        solution_config : SAGEOFASolutionConfig,
...
class SAGEOFA(BaseMultiTaskGNN):
...
@gml_solution
class SAGEOFASolution(BaseMultiTaskGMLSolution):

    config_class = SAGEOFASolutionConfig
    name = "sage-ofa"

    def create_model(self):
        return SAGEOFA(self.solution_config, self.data_config)
