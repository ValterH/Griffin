...
from .base_gml_solution import BaseGMLSolution, BaseGNN, BaseGNNSolutionConfig, BaseMultiTaskGMLSolution, BaseMultiTaskGNN
...
class SAGE_Multi(BaseMultiTaskGNN):
...
@gml_solution
class SAGEMultiSolution(BaseMultiTaskGMLSolution):

    config_class = SAGESolutionConfig
    name = "sage-multi"

    def create_model(self):
        return SAGE_Multi(self.solution_config, self.data_config)
